    ...
    "@graph": [
      {
        ...
        "@id": listing,
        url: siteUrl,
        name: "Casa Serenita | 1309 Queens Bush Road, Wellesley",
        description: "An 1835 six-bedroom house in Wellesley, Ontario, offered by private sale.",
      ...
      },
      {
        ...
        floorSize: { "@type": "QuantitativeValue", value: 4956, unitCode: "FTK" },
        photo: { "@id": image },
      },
      {
        "@type": "ImageObject",
        ...
        width: 1600,
        height: 900,
        caption: "Aerial view of Casa Serenita and its surrounding grounds",
      },
    ],
  };
}
